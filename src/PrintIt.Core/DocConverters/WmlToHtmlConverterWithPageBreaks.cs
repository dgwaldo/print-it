...
{
    /// <summary>
    /// TODO: Pulled this local because the current version doesn't yet deal with page breaks.
    /// https://github.com/EricWhiteDev/Open-Xml-PowerTools/tree/vNext/OpenXmlPowerTools
    /// This Code was from an unresolved PR against the old codebase. This could be used as a guide to update
    /// E. White's vNext github branch with a PR for supporting page breaks.
    /// </summary>
    ...
    public static class HtmlConverter
    {
        public static XElement ConvertToHtml(WmlDocument wmlDoc, HtmlConverterSettings htmlConverterSettings)
        {
            ...
            return WmlToHtmlConverterWithPageBreaks.ConvertToHtml(wmlDoc, settings);
        }

        public static XElement ConvertToHtml(WordprocessingDocument wDoc, HtmlConverterSettings htmlConverterSettings)
        {
            var settings = new WmlToHtmlConverterSettings(htmlConverterSettings);
            return WmlToHtmlConverterWithPageBreaks.ConvertToHtml(wDoc, settings);
        }
    }
    ...
    public static class WmlToHtmlConverterWithPageBreaks
    {
